...
| ------ | ----------------------------- | ------------------------------------------------ |
| S      | [Specific](#s---specific)     | Is the goal clearly and precisely defined?       |
| M      | [Measurable](#m---measurable) | Can progress and completion be measured?         |
| A      | [Attractive](#a---attractive) | Is the goal motivating for the team?             |
| R      | [Realistic](#r---realistic)   | Is the goal achievable with available resources? |
| T      | [Time-bound](#t---time-bound) | Does the goal have a clear deadline?             |
