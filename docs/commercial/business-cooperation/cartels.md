---
title: Cartels
description: Agreements between competing companies to restrict competition, with German cartel categories
keywords:
  - "Cartel"
  - "Competition Law"
  - "Antitrust"
...
| --------------------------------------- | ---------------------------------- |
| Higher profits due to less competition  | High fines for violations          |
| Less risk through coordinated behaviour | Dependence on other cartel members |
