...
| --------- | --------------------------------------------------------- | ---------------------------------------------------- |
| I         | [Unabhängig (Independent)](#i---unabhängig-independent)   | Kann es ohne andere Storys implementiert werden?     |
| N         | [Verhandelbar (Negotiable)](#n---verhandelbar-negotiable) | Ist es solange diskutierbar, bis es umsetzbar ist?   |
| V         | [Wertvoll (Valuable)](#v---wertvoll-valuable)             | Bringt es dem User einen Nutzen?                     |
| E         | [Schätzbar (Estimable)](#e---schätzbar-estimable)         | Kann der Aufwand für die Umsetzung geschätzt werden? |
| S         | [Klein (Small)](#s---klein-small)                         | Kann es innerhalb eines Sprints umgesetzt werden?    |
| T         | [Testbar (Testable)](#t---testbar-testable)               | Hat die Story klare Akzeptanzkriterien?              |
