...
- Einen Zeitplan erstellen (z.B. mit einem Gantt-Diagramm<!-- (./gantt.md) --> oder einem Netzwerkplan<!--(./network-plan.md) -->)
...
Die Test- und Überwachungsphase läuft oft parallel zur [Umsetzungsphase](#3-implementierung--ausführung). Das Ziel ist es sicherzustellen, dass die Ergebnisse die festgelegten Qualitätskriterien erfüllen.
...
| -------------------------------------------------------------- | ------------------------- | ------------------------------------ |
| [Initialisierung / Analyse](#1-initialisierung--analyse)       | Machbarkeit bewerten      | Projektcharta, Go/No-Go-Entscheidung |
| [Planung](#2-planung)                                          | Roadmap erstellen         | Projektplan, Zeitplan, Budget        |
| [Implementierung / Ausführung](#3-implementierung--ausführung) | Arbeit durchführen        | Ergebnisse, Statusberichte           |
| [Testing / Überwachung](#4-testing--überwachung)               | Qualität sicherstellen    | Testergebnisse, Fortschrittsberichte |
| [Abschluss / Betrieb](#5-abschluss--betrieb)                   | Abschließen oder Übergang | Akzeptanz, Erkenntnisse              |
